...
#Create a file named .env and upload your OpeanAI API key.
# If dont have one create one using this link:"https://platform.openai.com/"  
load_dotenv()
...
print("AI : Provide Content to be translate")
msgs = []
while True:
    usr_msg = input("You: ")
